    ...
    public function html()
    {
        return $this->builder()
                    ...
                    ->parameters([
                        'lengthMenu' =>[
                            [10,25,50,-1],
                            [ '10 rows', '25 rows', '50 rows', trans('admin.all_record') ]
                        ],
                        'buttons' =>[
                            ['text' => '<i class="fa fa-plus"></i> '.trans('admin.create_users'), 'className' => 'btn btn-info', "action" => "function(){
                        ...
                        //<input type="checkbox" class="delBtn" onclick="delete_all()" />
